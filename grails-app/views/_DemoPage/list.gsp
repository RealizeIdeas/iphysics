...
<section id="list-_DemoPage" class="first">
  ...
  <table class="table table-bordered">
    ...
    <tr>
      ...
      <g:sortableColumn property="myBoolean"
                        title="${message(code: '_DemoPage.myBoolean.label', default: 'My Boolean')}"/>
    ...
    <g:each in="${_DemoPageInstanceList}" status="i" var="_DemoPageInstance">
      <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
        ...
        <td><g:link action="show"
                    id="${_DemoPageInstance.id}">${fieldValue(bean: _DemoPageInstance, field: "name")}</g:link></td>
