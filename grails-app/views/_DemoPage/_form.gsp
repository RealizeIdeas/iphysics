...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myDate', 'error')} ">
  ...
  <div class="controls">
    <bs:datePicker name="myDate" precision="day" value="${_DemoPageInstance?.myDate}" default="none"
                   noSelection="['': '']"/>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myBoolean', 'error')} ">
  <label for="myBoolean" class="control-label"><g:message code="_DemoPage.myBoolean.label"
                                                          default="My Boolean"/></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myInt', 'error')} required">
  <label for="myInt" class="control-label"><g:message code="_DemoPage.myInt.label" default="My Int"/><span
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myShort', 'error')} required">
  <label for="myShort" class="control-label"><g:message code="_DemoPage.myShort.label" default="My Short"/><span
      class="required-indicator">*</span></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myLong', 'error')} required">
  <label for="myLong" class="control-label"><g:message code="_DemoPage.myLong.label" default="My Long"/><span
      class="required-indicator">*</span></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myFloat', 'error')} required">
  <label for="myFloat" class="control-label"><g:message code="_DemoPage.myFloat.label" default="My Float"/><span
      class="required-indicator">*</span></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myDouble', 'error')} required">
  <label for="myDouble" class="control-label"><g:message code="_DemoPage.myDouble.label" default="My Double"/><span
      class="required-indicator">*</span></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myByte', 'error')} required">
  <label for="myByte" class="control-label"><g:message code="_DemoPage.myByte.label" default="My Byte"/><span
      class="required-indicator">*</span></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myChar', 'error')} required">
  <label for="myChar" class="control-label"><g:message code="_DemoPage.myChar.label" default="My Char"/><span
      class="required-indicator">*</span></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myByteArray', 'error')} ">
  <label for="myByteArray" class="control-label"><g:message code="_DemoPage.myByteArray.label"
                                                            default="My Byte Array"/></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myInteger', 'error')} ">
  <label for="myInteger" class="control-label"><g:message code="_DemoPage.myInteger.label"
                                                          default="My Integer"/></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myTimeZone', 'error')} ">
  <label for="myTimeZone" class="control-label"><g:message code="_DemoPage.myTimeZone.label"
                                                           default="My Time Zone"/></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myCurrency', 'error')} ">
  <label for="myCurrency" class="control-label"><g:message code="_DemoPage.myCurrency.label"
                                                           default="My Currency"/></label>
...
<div class="control-group fieldcontain ${hasErrors(bean: _DemoPageInstance, field: 'myEnum', 'error')} required">
  <label for="myEnum" class="control-label"><g:message code="_DemoPage.myEnum.label" default="My Enum"/><span
      class="required-indicator">*</span></label>

  <div class="controls">
    <g:select name="myEnum" from="${kickstartwithbootstrapgrailsplugin._DemoPage$Suit?.values()}"
              keys="${kickstartwithbootstrapgrailsplugin._DemoPage$Suit.values()*.name()}" required=""
              value="${_DemoPageInstance?.myEnum?.name()}"/>
